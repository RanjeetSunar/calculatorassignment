package com.ranjeet.calculatorassignment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b1.setOnClickListener {
            ...
            tvsec.text = (tvsec.text.toString() + "1")
        }
        b2.setOnClickListener {
            // on below line we are appending
            // the expression to our text view.
            tvsec.text = (tvsec.text.toString() + "2")
        }
        b3.setOnClickListener {
            // on below line we are appending
            // the expression to our text view.
            tvsec.text = (tvsec.text.toString() + "3")
        }
        b4.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "4")
        }
        b5.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "5")
        }
        b6.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "6")
        }
        b7.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "7")
        }
        b8.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "8")
        }
        b9.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "9")
        }
        b0.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + "0")
        }
        bdot.setOnClickListener {
            tvsec.text = (tvsec.text.toString() + ".")
        }
        ...
        bminus.setOnClickListener {
            ...
            val str: String = tvsec.text.toString()
